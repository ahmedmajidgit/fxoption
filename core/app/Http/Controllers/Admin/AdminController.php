...
class AdminController extends Controller
{
    ...
    public function currencyPercentChange(Request $request)
    {   
       
        $input = $request->all();
        $validator = Validator::make($input, [
        'currenciesName' => 'required',
        'user_id' => 'required',
     ]);
      if($validator->fails()){
      return $this->sendError('Validation Error.', $validator->errors());       
       ...
       $coin=new Coin;
       $coin->currenciesName=$request->currenciesName;
       $coin->user_id=$request->user_id;
       $coin->save();
     
       return response()->json([
        "success" => true,
        "message" => "Currency percent updated", 
        ]);  
    }
